<template>
  <div class="sticky_header_content">
    <h2>表頭固定</h2>
    <p>當存在stickyHeader屬性時，表頭在垂直滾動狀態下可以固定在上方</p>
  ...
  <span class="html-tag">&lt;div</span> <span class="html-attr-name">class</span><span class="punctuation">=</span><span class="html-attr-value">"basic_table"</span><span class="html-tag">&gt;</span>
    <span class="html-tag">&lt;NtTable</span> <span class="vue-directive">:header</span><span class="punctuation">=</span><span class="html-attr-value">"tableHeader"</span> <span class="vue-directive">:data</span><span class="punctuation">=</span><span class="html-attr-value">"largeData"</span> <span class="vue-directive">stickyHeader</span><span class="html-tag">&gt;&lt;/NtTable&gt;</span>
