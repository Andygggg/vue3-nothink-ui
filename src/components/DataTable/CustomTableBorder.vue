<template>
  <div class="custom_border_content">
    <h2>網格線</h2>
    <p>以表格形式顯示資料</p>

    <div class="custom_border_table">
      <NtTable :header="tableHeader" :data="largeData" cell-border> </NtTable>
    </div>
...
<span class="html-tag">&lt;template&gt;</span>
 <span class="html-tag">&lt;div</span> <span class="html-attr-name">class</span><span class="punctuation">=</span><span class="html-attr-value">"custom_border_table"</span><span class="html-tag">&gt;</span>
   <span class="html-tag">&lt;NtTable</span> <span class="vue-directive">:header</span><span class="punctuation">=</span><span class="html-attr-value">"tableHeader"</span> <span class="vue-directive">:data</span><span class="punctuation">=</span><span class="html-attr-value">"largeData"</span> <span class="html-attr-name">cell-border</span><span class="html-tag">&gt;</span> <span class="html-tag">&lt;/NtTable&gt;</span>
