<template>
  <div class="custom_border_content">
    <h2>行間隔線</h2>
    <p>可以透過cell-border屬性為行與行間添加間隔線。</p>
...
&lt;<span class="html-tag">div</span> <span class="html-attr-name">class</span><span class="punctuation">=</span><span class="html-attr-value">"custom_border_table"</span>&gt;
  &lt;<span class="html-tag">NtTable</span> <span class="vue-directive">:header</span><span class="punctuation">=</span><span class="html-attr-value">"tableHeader"</span> <span class="vue-directive">:data</span><span class="punctuation">=</span><span class="html-attr-value">"largeData"</span> <span class="html-attr-name">cell-border</span>&gt; &lt;/<span class="html-tag">NtTable</span>&gt;
