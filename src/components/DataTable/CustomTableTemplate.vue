<template>
  <div class="custom_template_content">
    <h2>自訂內容</h2>
    <p>根據需求自訂單元格或表頭的顯示內容</p>

    <div class="custom_template_table">
      <NtTable :header="tableHeader" :data="largeData">
        <template #th_name="{ value }">
          <span>
            {{ value + '(自我介紹)' }}
          </span>
        </template>
        <template #td_name="{ value }">
          <span>
            {{ '大家好，我是' + value }}
          </span>
        </template>
  ...
  <span class="html-tag">&lt;div</span> <span class="html-attr-name">class</span><span class="punctuation">=</span><span class="html-attr-value">"custom_template_table"</span><span class="html-tag">&gt;</span>
    <span class="html-tag">&lt;NtTable</span> <span class="vue-directive">:header</span><span class="punctuation">=</span><span class="html-attr-value">"tableHeader"</span> <span class="vue-directive">:data</span><span class="punctuation">=</span><span class="html-attr-value">"largeData"</span><span class="html-tag">&gt;</span>
      <span class="html-tag">&lt;template</span> <span class="vue-directive">#th_name</span><span class="punctuation">=</span><span class="html-attr-value">"{ value }"</span><span class="html-tag">&gt;</span>
        <span class="html-tag">&lt;span&gt;</span>
          <span class="punctuation">&#123;&#123;</span> <span class="text-default">value</span> <span class="punctuation">+</span> <span class="js-string">'(自我介紹)'</span> <span class="punctuation">&#125;&#125;</span>
        <span class="html-tag">&lt;/span&gt;</span>
      <span class="html-tag">&lt;/template&gt;</span>
      <span class="html-tag">&lt;template</span> <span class="vue-directive">#td_name</span><span class="punctuation">=</span><span class="html-attr-value">"{ value }"</span><span class="html-tag">&gt;</span>
        <span class="html-tag">&lt;span&gt;</span>
          <span class="punctuation">&#123;&#123;</span> <span class="js-string">'大家好，我是'</span> <span class="punctuation">+</span> <span class="text-default">value</span> <span class="punctuation">&#125;&#125;</span>
        <span class="html-tag">&lt;/span&gt;</span>
      <span class="html-tag">&lt;/template&gt;</span>
