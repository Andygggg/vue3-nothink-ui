<template>
  <div class="horizontal_scroll_content">
    <h2>水平滾動</h2>
    <p>當資料超出表格的寬度時，會自動抓取表格當下的最大寬度並水平滾動</p>
 ...
 &lt;<span class="html-tag">div</span> <span class="html-attr-name">class</span><span class="punctuation">=</span><span class="html-attr-value">"horizontal_scroll_table"</span>&gt;
