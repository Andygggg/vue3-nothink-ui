<template>
 ...
 &lt;<span class="html-tag">div</span> <span class="html-attr-name">class</span><span class="punctuation">=</span><span class="html-attr-value">"basic_table"</span>&gt;
   &lt;<span class="html-tag">NtTable</span> <span class="vue-directive">:header</span><span class="punctuation">=</span><span class="html-attr-value">"tableHeader"</span> <span class="vue-directive">:data</span><span class="punctuation">=</span><span class="html-attr-value">"largeData"</span> <span class="vue-directive">:loading</span><span class="punctuation">=</span><span class="html-attr-value">"isLoading"</span>&gt; &lt;/<span class="html-tag">NtTable</span>&gt;
...
<span class="js-keyword">const</span> <span class="text-default">isLoading</span> <span class="punctuation">=</span> <span class="js-function">ref</span><span class="punctuation">(</span><span class="js-keyword">true</span><span class="punctuation">)</span>
